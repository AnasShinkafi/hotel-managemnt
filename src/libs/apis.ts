...
import { UpdateReviewDto, CreateReviewDto, Review } from "@/models/review";
...
export const createBooking = async ({
  ...
  const { data } = await axios.post(
    `https://${process.env.NEXT_PUBLIC_SANITY_PROJECT_ID}.api.sanity.io/v2023-10-16/adta/mutate/${process.env.NEXT_PUBLIC_SANITY_DATASET}`,
    mutation,
